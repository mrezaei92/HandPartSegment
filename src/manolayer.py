...
class ManoLayer(Module):
    ...
    def forward(self,
        ...
        th_jtr = th_jtr[:, [0, 13, 14, 15, 16, 1, 2, 3, 17, 4, 5, 6, 18, 10, 11, 12, 19, 7, 8, 9, 20]] #get_NYU_compatible_joints(th_verts,th_jtr)#
        th_jtr = get_NYU_compatible_joints(th_verts,th_jtr)#
